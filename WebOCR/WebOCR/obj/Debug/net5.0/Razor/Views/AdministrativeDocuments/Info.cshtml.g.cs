#pragma checksum "D:\Libra\OCR\WebOCR\WebOCR\Views\AdministrativeDocuments\Info.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e6d0482729c0fde868045189ff430b35db89863f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_AdministrativeDocuments_Info), @"mvc.1.0.view", @"/Views/AdministrativeDocuments/Info.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e6d0482729c0fde868045189ff430b35db89863f", @"/Views/AdministrativeDocuments/Info.cshtml")]
    ...
    #nullable restore
    public class Views_AdministrativeDocuments_Info : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<WebOCR.Models.FileForm>
    #nullable disable
    {
        ...
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_5 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("asp-controller", "AdministrativeDocuments", global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        ...
        {
#nullable restore
#line 1 "D:\Libra\OCR\WebOCR\WebOCR\Views\AdministrativeDocuments\Info.cshtml"
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e6d0482729c0fde868045189ff430b35db89863f8080", async() => {
                WriteLiteral(@"
    <div class=""row"">
        <div class=""col-12"">
                    ...
                    <div class=""row"">
                        <div class=""col-sm-4 file-upload"">
                            ...
                            <div class=""file-select"">
                                ...
                                ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("input", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "e6d0482729c0fde868045189ff430b35db89863f9019", async() => {
                }
                );
...
#nullable restore
#line 33 "D:\Libra\OCR\WebOCR\WebOCR\Views\AdministrativeDocuments\Info.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@"
                        ...
                        <div class=""col-sm-2 text-center   m-t-36"">
                            ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e6d0482729c0fde868045189ff430b35db89863f11497", async() => {
            ...
            <div class=""card mini-stat"">
                <div class=""p-l-r-20 bg-primary text-white"">
                    <div class=""mini-stat-icon"">
                        <i ");
                WriteLiteral(@"class=""mdi mdi-image float-right mb-0""></i>
                    </div>
        ...
        <div class=""col-md-6"">
            <div class=""card mini-stat"">
                ...
                <div class=""btn-group btn-group-toggle"">
                    ...
                    <a href=""#"" class=""btn btn-outline-primary tab"">Json<");
                WriteLiteral(@"/a>
                </div>
                <div class=""card-body p-1r"">
                    <div class=""text-muted"">
...
<script>
    ...
    $('#upload').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/AdministrativeDocuments/GetInfo',
            dataType: 'json',
            cache: false,
            contentType: false,
            processData: false,
 ...
 ");
            WriteLiteral(@"                       $('#result').val(""Empty"");
                    ...
                    html += ""<p>"" + ""<strong>Số kí hiệu: </strong>"" + (getSafe(() => response.value.so_ky_hieu, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Số trang: </strong>"" + (getSafe(() => response.value.so_trang, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Tên văn bản: </strong>"" + (getSafe(() => response.value.ten_van_ban, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Trích yếu: </strong>"" + (getSafe(() => response.value.tr");
            WriteLiteral(@"ich_yeu, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Người ký: </strong>"" + (getSafe(() => response.value.nguoi_ky, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Chức vụ: </strong>"" + (getSafe(() => response.value.chuc_vu, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Cơ quan ban hành: </strong>"" + (getSafe(() => response.value.co_quan_ban_hanh, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Loại văn bản: </strong>"" + (getSafe(() => response.value.doc_type, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Ngôn ngữ: </strong>"" + (getSafe(() => response.value.lang, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Ngày ban hành: </strong>"" + (getSafe(() => response.value.ngay_ban_hanh.ngay, ''))  + (getSafe(() => response.value.ngay_ban_hanh.thang, ''))  + (getSafe(() => response.value.ngay_ban_hanh.nam, '')) + ""</p>""
                    html += '<div class=""row"">'
                    html += '<label for=""insideReceiver"" class=""m-l-");
            WriteLiteral(@"15"" ><strong>Nơi nhận bên trong: </strong></label>'
    ...
    $('#SaveResult').click(function(e) {
        ...
        var input = document.getElementById('inputFile');
        var size = Math.");
            WriteLiteral(@"round(input.files[0].size / 1024);
        ...
        if (htmlValue.length == 0 || jsonValue.length == 0) {
            ...
            $.ajax({
                type: ""POST"",
                url: ""/AdministrativeDocuments/Save"",
                cache: false,
                contentType: false,
                processData: false,
                data: formData,
