#pragma checksum "D:\Libra\OCR\WebOCR\WebOCR\Views\HealthRecords\Info.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "65f4ba91779b1836a76bc0e64fd711cb63844e2f"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_HealthRecords_Info), @"mvc.1.0.view", @"/Views/HealthRecords/Info.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"65f4ba91779b1836a76bc0e64fd711cb63844e2f", @"/Views/HealthRecords/Info.cshtml")]
    ...
    #nullable restore
    public class Views_HealthRecords_Info : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<WebOCR.Models.FileForm>
    #nullable disable
    {
        ...
        private static readonly global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute __tagHelperAttribute_5 = new global::Microsoft.AspNetCore.Razor.TagHelpers.TagHelperAttribute("asp-controller", "HealthRecords", global::Microsoft.AspNetCore.Razor.TagHelpers.HtmlAttributeValueStyle.DoubleQuotes);
        ...
        {
#nullable restore
#line 1 "D:\Libra\OCR\WebOCR\WebOCR\Views\HealthRecords\Info.cshtml"
        ...
        <div class=""page-title-box"">
            <div class=""btn-group float-right m-t-b-10"">
                <ol class=""breadcrumb hide-phone p-0 m-0"">
                    ...
                    <li class=""breadcrumb-item""><a href=""#"">Health Records</a></li>
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "65f4ba91779b1836a76bc0e64fd711cb63844e2f8000", async() => {
                WriteLiteral(@"
    <div class=""row"">
        <div class=""col-12"">
                    ...
                    <div class=""row"">
                        <div class=""col-sm-4 file-upload"">
                            ...
                            <div class=""file-select"">
                                ...
                                ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("input", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "65f4ba91779b1836a76bc0e64fd711cb63844e2f8939", async() => {
                }
                );
...
#nullable restore
#line 33 "D:\Libra\OCR\WebOCR\WebOCR\Views\HealthRecords\Info.cshtml"
...
#nullable disable
                ...
                WriteLiteral(@"
                        ...
                        <div class=""col-sm-2 text-center   m-t-36"">
                            ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "65f4ba91779b1836a76bc0e64fd711cb63844e2f11407", async() => {
            ...
            <div class=""card mini-stat"">
                <div class=""p-l-r-20 bg-primary text-white"">
                    <div class=""mini-stat-icon"">
                        <i class=""mdi mdi");
                WriteLiteral(@"-image float-right mb-0""></i>
                    </div>
...
<script>
    ...
    function switchClass(e) {
        ...
        const index = Array.prototype.slice.call(e.target.parentElement.c");
            WriteLiteral(@"hildren).indexOf(e.target)
    ...
    $('#upload').submit(function(e) {
        ...
        if (document.getElementById('in");
            WriteLiteral(@"putFile').files.length == 0) {
        ...
        $.ajax({
            ...
            WriteLiteral(@"       $('#result').val(""Empty"");
                    ...
                    html += ""<p>"" + ""<strong>Địa chỉ bệnh nhân: </strong>"" + (getSafe(() => response.value.dia_chi_benh_nhan, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Ký hiệu hóa đơn: </strong>"" + (getSafe(() => response.value.ky_hieu_hoa_don, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Loại văn bản: </strong>"" + (getSafe(() => response.value.loai_vb, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Mã số thuế hóa đơn: </strong>"" + (getSafe(() => response.value.ma_so_thue_hoa_don, '')) + ""</p>""
                    html += """);
            WriteLiteral(@"<p>"" + ""<strong>Mẫu số hóa đơn: </strong>"" + (getSafe(() => response.value.mau_so_hoa_don, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Số hóa đơn: </strong>"" + (getSafe(() => response.value.so_hoa_don, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Tên bệnh nhân: </strong>"" + (getSafe(() => response.value.ten_benh_nhan, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Tên bệnh viện: </strong>"" + (getSafe(() => response.value.ten_benh_vien, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Tên văn bản: </strong>"" + (getSafe(() => response.value.ten_van_ban, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Tên dịch vụ: </strong>"" + (getSafe(() => response.value.ten_dich_vu, '')) + ""</p>""
                    html += ""<p>"" + ""<strong>Thông tin thời gian: </strong>"" + (getSafe(() => response.value.thong_tin_thoi_gian.ngay, '')) + (getSafe(() => response.value.thong_tin_thoi_gian.thang, '')) + (getSafe(() => response.value.thong_tin_thoi_gian.nam, '')) +");
            WriteLiteral(@" ""</p>""
                    html += ""<p>"" + ""<strong>Tổng tiền bằng số: </strong>"" + (getSafe(() => response.value.tong_tien_bang_so, '')) + ""</p>""
                    html += ""</div>"";
    ...
    function showPreview(event) {
        if (event.target.files.length > 0) {
            ...
            var pr");
            WriteLiteral(@"eview = document.getElementById(""image_input"");
            preview.src = src;
